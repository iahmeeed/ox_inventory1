...
exports('armor_plate', function(data, slot)
    -- Check if there is a vest in the "equipped" slot (Slot 2)
    local armorItem = exports.ox_inventory:GetSlot(2)
    
    if not armorItem then
        lib.notify({ description = 'You are not wearing any armor!', type = 'error' })
        return
    end
