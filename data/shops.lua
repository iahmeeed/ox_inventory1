return {
	...
	BlackMarketArms = {
		...
		inventory = {
			...
			{ loc = vector3(309.67990112305, -913.83270263672, 56.73278427124), length = 0.5, width = 0.5, heading = 270.0, minZ = 56.5, maxZ = 57.0, distance = 1 }
		}
	},
	...
	General = {
		...
		inventory = {
			...
			vec3(47.052516937256, -1749.7303466797, 29.99528503418),
		}, targets = {
			{ loc = vec3(47.052516937256, -1749.7303466797, 29.99528503418), length = 0.7, width = 0.5, heading = 0.0, minZ = 29.5, maxZ = 30.0, distance = 1.5 },
		}
	},
